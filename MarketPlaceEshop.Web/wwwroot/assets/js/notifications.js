!(function (t) {
        ...
        !(function (t) {
            function n(t) {
                return (
                    ...
                    (console.warn(
                        "An invalid notification position class has been specified."
                    ),
                        (t.positionClass = c.positionClass)),
                    t.onclick &&
                    "function" != typeof t.onclick &&
                    (console.warn("Notification on click must be a function."),
                        (t.onclick = c.onclick)),
                    "number" != typeof t.showDuration &&
                    (t.showDuration = c.showDuration),
            ...
            function e(t) {
                return (
                    ...
                    function () {
                        ...
                        if (!e && !i)
                            return console.warn(
                                "Notification must contain a title or a message!"
                            );
                        ...
                        if (
                            ((0, o.isString)(e) &&
                                e.length &&
                                (0, o.append)(a, (0, o.createParagraph)("ncf-title")(e)),
                                (0, o.isString)(i) &&
                                i.length &&
                                (0, o.append)(a, (0, o.createParagraph)("nfc-message")(i)),
                                (0, o.append)(c, a),
                                t.showDuration && t.showDuration > 0)
                        ) {
                            var l = setTimeout(function () {
                                c.removeChild(a),
                                    0 === c.querySelectorAll(".ncf").length &&
            ...
            function r(t) {
                ...
                return (
                    n ||
                    ((n = (0, o.createElement)("div", "ncf-container", t)),
                        (0, o.append)(document.body, n)),
                    n
                );
            }
            var c = {
            ...
            t.createNotification
                ? console.warn(
                    "Window already contains a create notification function. Have you included the script twice?"
                )
    ...
    function (t, n, e) {
        ...
        var i = (n.partial = function (t) {
            ...
            c = function (t) {
                for (
                    var n = arguments.length, e = Array(n > 1 ? n - 1 : 0), c = 1;
                    c < n;
                    c++
                )
                    e[c - 1] = arguments[c];
