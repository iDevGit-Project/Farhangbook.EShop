...
{
    public class UserPanel_BreadCrumbViewComponent : ViewComponent
    {
        private readonly IUserService _userService;
        public UserPanel_BreadCrumbViewComponent(IUserService userService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("UserPanel_BreadCrumb");
        }
